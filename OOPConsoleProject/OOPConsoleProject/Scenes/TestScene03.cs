...
{
    internal class TestScene03 : BaseScene
    {
        private ConsoleKey input;
        public override void Render()
        {
            Console.WriteLine("테스트 씬 03");
            Console.WriteLine();
            Console.WriteLine("1. 테스트 1씬으로 이동");
            Console.WriteLine("2. 테스트 2씬으로 이동");
        ...
        public override void Result()
        {
            ...
            {
                case ConsoleKey.D1:
                    Util.PressAnyKey("테스트 씬 03에서 테스트 씬 1로 이동합니다.");
                    Game.ChangeScene("Test1");
                    break;
                case ConsoleKey.D2:
                    Util.PressAnyKey("테스트 씬 03에서 테스트 씬 2로 이동합니다.");
